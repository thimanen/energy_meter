...
|13.5.|2|Implement a function to read values from a time range betwen start and end timestamps.|next implement a GET route to enable value read from MongoDB|
